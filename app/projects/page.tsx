...
export default async function ProjectsPage() {
    ...
    return (
        <section className="max-w-7xl w-full px-4 md:px-8 mx-auto">
            ...
            <p className="leading-7 text-muted-foreground mt-2">Check out what projects I have created</p>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                                {item.tags.map((tagItem, index) => (
                                    <span key={index}  className="inline-flex items-center rounded-md bg-primary/10 px-3 py-1.5 text-xs sm:text-sm font-medium text-primary ring-2 ring-inset ring-primary/20">
                                        {tagItem}
                                    </span>
                                ))}
                            </div>
